            ...
            <div className="card bg-dark text-white shadow p-4">
              ...
              {isAuthenticated && stats && (
                <div className="row row-cols-1 row-cols-md-2 g-4">
                  {/* Total Plays */}
                  <div className="col">
                    <div className="card bg-secondary h-100 text-white text-center">
                      ...
                      <div className="card bg-secondary h-100">
                        <div className="card-body d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <p className="fw-bold fs-5 mb-1">{stats.most_played_song}</p> {/* Bigger song name */}
                      ...
                      <div className="card bg-secondary h-100">
                        <div className="card-body d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <p className="fw-bold fs-5 mb-0">{stats.most_played_artist}</p> {/* Bigger artist name */}
                          </div>
                        </div>
                      </div>
                    </Link>
                      ...
                      <div className="card bg-secondary h-100">
                        <div className="card-body d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <p className="fw-bold fs-5 mb-1">{stats.longest_binge_song}</p> {/* Bigger song name */}
